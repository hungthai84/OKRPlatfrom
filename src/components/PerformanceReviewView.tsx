          ...
          <div className="flex space-x-6 text-sm font-semibold">
            <button 
              ...
              className={`pb-1 border-b-2 cursor-pointer transition-all ${
                activeSubTab === 'cycles' ? 'border-orange-500 text-slate-800 dark:text-slate-200 font-bold' : 'border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:text-slate-200'
              }`}
            >
            ...
            <button 
              ...
              className={`pb-1 border-b-2 cursor-pointer transition-all ${
                activeSubTab === 'self' ? 'border-orange-500 text-slate-800 dark:text-slate-200 font-bold' : 'border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:text-slate-200'
              }`}
            >
            ...
            <button 
              ...
              className={`pb-1 border-b-2 cursor-pointer transition-all ${
                activeSubTab === 'calibration' ? 'border-orange-500 text-slate-800 dark:text-slate-200 font-bold' : 'border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:text-slate-200'
              }`}
            >
